// Congelado desde el antiguo src/scripts/migrate.js: crea el esquema completo tal
// como existía antes de introducir el ledger de migraciones (schema_migrations).
// Conserva sus guardas (IF NOT EXISTS / try-catch por código de error de MySQL) a
// propósito, para que sea inofensivo re-ejecutarlo contra una base que ya tiene
// este esquema aplicado por el script anterior.

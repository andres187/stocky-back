...
Stocky is a consignment shop: individual owners ("sellers") list their own clothes and the store keeps a commission on each sale. This is **not** an extension of admin or customer auth — it's a third parallel system, same reasoning as customer vs admin (a bug mixing up cookies must fail closed):
